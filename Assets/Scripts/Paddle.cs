...
public class Paddle : MonoBehaviour
{
    ...
    private Collider2D collider2D_left;
    ...
    void Start()
    {
        ...
        collider2D_left = boardLeft.GetComponent<Collider2D>();
        //collider2D_merged = paddleMerged.GetComponent<Collider2D>();
        
        central_point = GlobleData.getLevelCenter(GlobleData.currentLevel);
        ...
        if (Input.touchCount > 0)
        {
            ...
            { 
                ...
                if (touch.phase == TouchPhase.Began)
                {
                    ...
                    if (touchedCollider == collider2D_right|| touchedCollider == collider2D_left)
                    {
                        DragObject drag0;
                ...
                else if (touch.phase == TouchPhase.Moved)
                {
                    ...
                    if (draggedObjects.TryGetValue(touch.fingerId, out drag0))
                    {
                        ...
                        if (drag0.paddle == collider2D_right && touchPosition.y >= 0.5f ||
                            drag0.paddle == collider2D_left && touchPosition.y >= 0.5f)
                        {
